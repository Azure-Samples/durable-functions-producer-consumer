...
namespace ConsumerCode
{
    ...
    {
        public static async Task ConsumeAsync(EventData[] ehMessages, PartitionContext partitionContext, IAsyncCollector<string> collector, ILogger log, string instanceId)
        {
